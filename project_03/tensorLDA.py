...
if __name__ == '__main__':
    ...
    computeContractionDuration = stop - start
    ...
    print("computeContractionDuration", computeContractionDuration)
    print("evaluationDuration", evaluationDuration)
    print("predictionDuration", predictionDuration)